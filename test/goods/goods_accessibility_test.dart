...
import 'package:flutter_deer_djzhang/goods/page/goods_size_page.dart';
    ...
    map.forEach((name, page) {
      testWidgets(name, (WidgetTester tester) async {
        ...
        handle.dispose();
          ...
          skip: name == 'goods_search_page' ||
              name ==
                  'goods_size_page'); // https://github.com/flutter/flutter/issues/42455
    });
  });
