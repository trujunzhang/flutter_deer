...
import 'package:flutter_deer_djzhang/order/page/order_info_page.dart';
import 'package:flutter_deer_djzhang/order/page/order_page.dart';
import 'package:flutter_deer_djzhang/order/page/order_track_page.dart';
      ...
      testWidgets(name, (WidgetTester tester) async {
        ...
        handle.dispose();
          ...
          skip: name == 'order_search_page' ||
              ...
              name ==
                  'order_page'); // https://github.com/flutter/flutter/issues/42455
    });
  });
