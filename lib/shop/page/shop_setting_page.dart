...
import 'package:flutter_deer_djzhang/shop/widgets/pay_type_dialog.dart';
import 'package:flutter_deer_djzhang/shop/shop_router.dart';
import 'package:flutter_deer_djzhang/shop/widgets/price_input_dialog.dart';
import 'package:flutter_deer_djzhang/shop/widgets/send_type_dialog.dart';
...
class _ShopSettingPageState extends State<ShopSettingPage> {
        ...
        body: MyScrollView(
          ...
          children: <Widget>[
            ...
            const Padding(
              ...
              child: Text('基础设置', style: AppTextStyles.textBold18),
            ),
            Gaps.vGap16,
            ClickItem(
              title: '店铺简介',
            ...
            const Padding(
              padding: EdgeInsets.only(left: 16.0),
              child: Text('运费设置', style: AppTextStyles.textBold18),
            ),
            Gaps.vGap16,
            ClickItem(
              title: '运费配置',
  ...
  void _goInputTextPage(BuildContext context, String title, String hintText,
    ...
    NavigatorUtils.pushResult(context, ShopRouter.inputTextPage, function,
