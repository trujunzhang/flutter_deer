...
import 'package:flutter_deer_djzhang/widgets/selected_image.dart';
  ...
  List<Widget> _buildBody() {
    return [
      ...
      const Padding(
        ...
        child: Text('店铺资料', style: AppTextStyles.textBold18),
      ),
      Gaps.vGap16,
      Center(
        child: SelectedImage(
      ...
      const Padding(
        padding: EdgeInsets.only(left: 16.0),
        child: Text('店主信息', style: AppTextStyles.textBold18),
      ),
      Gaps.vGap16,
