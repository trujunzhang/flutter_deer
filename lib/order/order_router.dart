...
class OrderRouter implements IRouterProvider {
  ...
  void initRouter(FluroRouter router) {
    ...
    router.define(orderInfoPage,
        handler: Handler(handlerFunc: (_, __) => const OrderInfoPage()));
    router.define(orderSearchPage,
        handler: Handler(handlerFunc: (_, __) => const OrderSearchPage()));
    router.define(orderTrackPage,
        handler: Handler(handlerFunc: (_, __) => const OrderTrackPage()));
  }
}
