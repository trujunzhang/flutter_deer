...
import 'package:flutter_deer_djzhang/order/widgets/pay_type_dialog.dart';
...
class OrderItem extends StatelessWidget {
  ...
  Widget _buildContent(BuildContext context) {
    final TextStyle? textTextStyle = Theme.of(context)
        .textTheme
        .bodyText2
        ?.copyWith(fontSize: AppDimens.font_sp12);
        ...
        RichText(
          text: TextSpan(
            ...
            children: <TextSpan>[
              const TextSpan(text: '清凉一度抽纸'),
              TextSpan(
                  text: '  x2', style: Theme.of(context).textTheme.subtitle2),
            ],
          ),
        ),
        Gaps.vGap12,
                  ...
                  children: <TextSpan>[
                    ...
                    TextSpan(
                        ...
                        style: Theme.of(context)
                            .textTheme
                            .subtitle2
                            ?.copyWith(fontSize: AppDimens.font_sp10)),
                  ],
                ),
              ),
            ),
        ...
        Row(
          children: <Widget>[
            OrderItemButton(
              ...
              text: '联系客户',
              textColor: isDark ? AppColors.dark_text : AppColors.text,
              bgColor: isDark ? AppColors.dark_material_bg : AppColors.bg_gray,
            ...
            if (orderRightButtonText[tabIndex].isEmpty)
              ...
              OrderItemButton(
                ...
                bgColor: isDark ? AppColors.dark_app_main : AppColors.app_main,
                onTap: () {
                  if (tabIndex == 2) {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      child: Container(
        ...
        child: Text(
          text,
          style: TextStyle(fontSize: AppDimens.font_sp14, color: textColor),
        ),
      ),
      onTap: onTap,
    );
