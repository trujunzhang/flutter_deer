            ...
            Expanded(
              ...
              child: MyButton(
                backgroundColor: isDark
                    ? AppColors.dark_material_bg
                    : const Color(0xFFE1EAFA),
                textColor: isDark ? AppColors.dark_text : AppColors.app_main,
                text: '拒单',
                minHeight: 45,
                onPressed: () {},
              ),
  ...
  Widget _buildOrderGoodsItem(int index) {
    final Widget item = Row(
      ...
      children: <Widget>[
        ...
        Gaps.hGap8,
        const Text('x1', style: AppTextStyles.textSize12),
        Gaps.hGap32,
        Text(Utils.formatPrice('25'), style: AppTextStyles.textBold14),
      ],
    );
