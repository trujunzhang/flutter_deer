        ...
        Positioned(
          ...
          child: Text(widget.data.typeName,
              style: const TextStyle(
                  color: Colors.white, fontSize: AppDimens.font_sp18)),
        ),
        Positioned(
          top: 48.0,
          left: 72.0,
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          child: Transform(
            ...
            child: const Text('提现',
                style: TextStyle(
                    color: Colors.white, fontSize: AppDimens.font_sp16)),
          ),
        ),
      ),
    );
...
class AccountCard extends StatefulWidget {
  const AccountCard({Key? key, required this.child, required this.type})
      : super(key: key);
        ...
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(
            colors: widget.type == 1
                ...
                : const [Color(0xFF57C4FA), AppColors.app_main],
          ),
        ),
        child: widget.child,
      ),
