...
class WithdrawalPasswordSetting extends StatefulWidget {
  ...
  @override
  _WithdrawalPasswordSettingState createState() =>
      _WithdrawalPasswordSettingState();
}
...
class _WithdrawalPasswordSettingState extends State<WithdrawalPasswordSetting> {
                ...
                children: <Widget>[
                  Container(
                    ...
                    decoration: BoxDecoration(
                      border:
                          Border.all(width: 0.6, color: AppColors.text_gray_c),
  ...
  Widget _buildButton(int index) {
    final color =
        context.isDark ? AppColors.dark_bg_gray : AppColors.dark_button_text;
    return Material(
          ...
          border: p != 5
              ? Border(
                  right: Divider.createBorderSide(context,
                      color: AppColors.text_gray_c, width: 0.6),
                )
              : null,
        ),
        child: Text(
