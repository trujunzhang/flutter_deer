...
class _WithdrawalPasswordSettingState extends State<WithdrawalPasswordSetting> {
              ...
              children: <Widget>[
                Container(
                  ...
                  decoration: BoxDecoration(
                    border: Border.all(width: 0.6, color: AppColors.text_gray_c),
  ...
  Widget _buildButton(int index) {
    final color = context.isDark ? AppColors.dark_bg_gray : AppColors.dark_button_text;
    return Material(
  ...
  Widget _buildInputWidget(int p) {
    return Expanded(
      child: Container(
        ...
        decoration: BoxDecoration(
          border: p != 5 ? Border(
            right: Divider.createBorderSide(context, color: AppColors.text_gray_c, width: 0.6),
          ) : null,
        ),
        child: Text(_codeList[p].isEmpty ? '' : '●', style: AppTextStyles.textSize12,),
      ),
    );
  }
}
