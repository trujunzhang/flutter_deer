    ...
    final Widget child = Column(
      children: <Widget>[
        ...
        const Padding(
          ...
          child: Text('本次操作需短信验证，验证码会发送至您的注册手机 15000000000',
            ...
            children: <Widget>[
              EditableText(
                ...
                style: const TextStyle(
                    color: Colors.transparent, fontSize: AppDimens.font_sp18),
                onChanged: (v) {
        ...
        MyButton(
          ...
          textColor: textColor,
          disabledTextColor: AppColors.text_gray,
    ...
    return Container(
        ...
        decoration: BoxDecoration(
          border: Border.all(
              width: 0.6,
              color:
                  _codeList[p].isNotEmpty ? textColor : AppColors.text_gray_c),
          borderRadius: BorderRadius.circular(4.0),
        ),
        child: Text(
          _codeList[p],
          style: const TextStyle(fontSize: AppDimens.font_sp18),
        ));
  }
}
