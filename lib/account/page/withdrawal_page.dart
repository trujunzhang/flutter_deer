          ...
          children: <Widget>[
            ...
            Row(
              ...
              children: const <Widget>[
                Text('提现金额', style: AppTextStyles.textBold14),
                Text('单笔2万，单日2万',
                    style: TextStyle(
                        fontSize: AppDimens.font_sp12, color: AppColors.orange))
              ],
            ),
            Gaps.vGap8,
            Row(
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: const <Widget>[
                Text('转出方式', style: AppTextStyles.textBold14),
