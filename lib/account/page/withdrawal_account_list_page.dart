...
class WithdrawalAccountListPage extends StatefulWidget {
  ...
  @override
  _WithdrawalAccountListPageState createState() =>
      _WithdrawalAccountListPageState();
}
    ...
    return Scaffold(
      appBar: MyAppBar(
          ...
          onPressed: () => NavigatorUtils.push(
              context, AccountRouter.addWithdrawalAccountPage)),
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(
          children: <Widget>[
            LoadAssetImage(
                _list[index].type == 0 ? 'account/yhk' : 'account/wechat',
                width: 24.0),
            Gaps.hGap16,
            Expanded(
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Gaps.vGap8,
                  Text(_list[index].name, style: AppTextStyles.textSize12),
                ],
              ),
            ),
            Visibility(
