...
class _GoodsStatisticsPageState extends State<GoodsStatisticsPage> {
      ...
      body: SingleChildScrollView(
        ...
        child: SafeArea(
          child: Column(
            ...
            children: <Widget>[
              Gaps.vGap4,
              Text(_type ? '已配货' : '待配货', style: AppTextStyles.textBold24),
              Gaps.vGap32,
              if (_type)
                time
              else
              ...
              Gaps.vGap8,
              _buildChart(),
              const Text('热销商品排行', style: AppTextStyles.textBold18),
              ListView.builder(
  ...
  Widget _buildSelectedText(String text, int index) {
    final Color unSelectedTextColor =
        context.isDark ? Colors.white : AppColors.dark_text_gray;
    return SelectedDateButton(
      text,
      fontSize: AppDimens.font_sp15,
