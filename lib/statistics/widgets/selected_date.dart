...
class SelectedDateButton extends StatelessWidget {
        ...
        child: Container(
          ...
          decoration: selected ? BoxDecoration(
            ...
            boxShadow: context.isDark ? null : const [
              BoxShadow(color: AppColors.shadow_blue, offset: Offset(0.0, 2.0), blurRadius: 8.0, spreadRadius: 0.0),
            ],
            gradient: const LinearGradient(
              begin: Alignment.topCenter,
              end: Alignment.bottomCenter,
              colors: [Color(0xFF5758FA), AppColors.gradient_blue],
            ),
          ) : null,
  ...
  Color getTextColor() {
    return enable ? (selected ? Colors.white : unSelectedTextColor) : AppColors.text_gray_c;
  }
}
