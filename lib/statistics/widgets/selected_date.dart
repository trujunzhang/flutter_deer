...
class SelectedDateButton extends StatelessWidget {
  const SelectedDateButton(this.text,
      ...
      this.onTap,
      this.semanticsLabel})
      : assert(unSelectedTextColor != null,
            'The [unSelectedTextColor] argument must not be null.'),
        super(key: key);
        ...
        text: TextSpan(
          children: <TextSpan>[
            ...
            TextSpan(
                ...
                style:
                    TextStyle(color: getTextColor(), fontSize: fontSize - 4.0)),
          ],
        ),
      );
    } else {
